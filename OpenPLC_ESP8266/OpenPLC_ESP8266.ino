...
const char *ssid = "Casa_2.4G";
const char *password = "99416940";
...
{  
    ...
    if (!client){
      Serial.println("nteeestet!");
              return;}
    

        
    // Começando LED Device Status desligado
    //digitalWrite(2, LOW);
    ...
    {
        // Liga o LED Device Status (VERDE)
        //digitalWrite(2, HIGH);
        ...
        while(client.available())
        {
            // Ligando Communication LED (AMARELO)
            //digitalWrite(3, HIGH);
        ...
        */
        ...
        //digitalWrite(3, HIGH); //LED communication
        client.write((const uint8_t *)modbus_buffer, return_length);
        updateIO();
        //digitalWrite(3, LOW); //LED Communication
        delay(1);
    }
